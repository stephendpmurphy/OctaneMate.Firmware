...
void SERIAL_FLASH_SPI_example(void)
{
	struct io_descriptor *io;
	spi_m_sync_get_io_descriptor(&SERIAL_FLASH_SPI, &io);

	spi_m_sync_enable(&SERIAL_FLASH_SPI);
	io_write(io, example_SERIAL_FLASH_SPI, 12);
}
